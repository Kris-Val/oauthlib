...
class ErrorResponseTest(TestCase):
    ...
    def test_invalid_content_type(self):
        """
        Test that requests with invalid content-type raise UnsupportedTokenTypeError
        """
        self.validator.authenticate_client.side_effect = self.set_client
        ...
        try:
            ...
            self.fail('This should have failed with UnsupportedTokenTypeError')
        except errors.UnsupportedTokenTypeError as ire:
